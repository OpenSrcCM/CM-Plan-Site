...
==== Preprequisites
* Install Git on your system per the https://github.com/cmguy/CM-Plan-Site/blob/initial/app/site/newstuff/GitInstallationProcedure.html[Install Git] procedure.
