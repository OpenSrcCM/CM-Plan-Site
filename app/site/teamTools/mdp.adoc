...
https://www.webopedia.com/TERM/D/devops_development_operations.html[DevOps] is a modern approach that drives this MDP. The guiding principles of DevOps include culture, measurement, automation and sharing.
